...
public class ArtistCSVFormatter extends CSVDataSetFormatter<Artist, Attribute> {
     ...
     */
    @Override
    public String[] format(Artist record, DataSet<Artist, Attribute> dataset, List<Attribute> orderedHeader) {
        return new String[] {
